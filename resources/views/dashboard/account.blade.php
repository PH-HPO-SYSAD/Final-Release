    ...
    <div class="row">
    	<div class="col-md-4">
			<div class="list-group">
			  ...
			  <a href="#" class="list-group-item">Name:&nbsp&nbsp{{ auth()->user()->name }}
			  </a>
			  <a href="#" class="list-group-item">Username:&nbsp&nbsp{{ auth()->user()->username }}
			  </a>
			   <a href="#" class="list-group-item">Account Type:&nbsp&nbsp{{ auth()->user()->account_type }}
			  </a>
			</div>
    	</div>
    </div>
